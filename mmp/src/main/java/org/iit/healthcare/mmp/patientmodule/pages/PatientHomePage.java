...
public class PatientHomePage {
	...
	public boolean validatePatientPortalMessage() {
		...
		Boolean result = wait.until(ExpectedConditions
				.textToBePresentInElementLocated(By.xpath("//h3[@class='panel-title']"), "Patient Portal"));
		return result;
	}
	...
	public HashMap<String, String> validateApptDetailsinHomePage() {
		...
		homePageDetailsHMap.put("dateofAppointment",
				driver.findElement(By.xpath("//table[@class='table']//tr[1]/td[1]")).getText());
		homePageDetailsHMap.put("time", driver.findElement(By.xpath("//table[@class='table']//tr[1]/td[2]")).getText());
		homePageDetailsHMap.put("symptoms", driver.findElement(By.xpath("//table[@class='table']//tr[1]/td[3]")).getText());
		homePageDetailsHMap.put("doctorName",
				driver.findElement(By.xpath("//table[@class='table']//tr[1]/td[4]")).getText());
